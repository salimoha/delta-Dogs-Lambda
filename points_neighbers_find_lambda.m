function [x,xE,xU,newadd,sucess]=points_neighbers_find_lambda(x,xE,xU)
...
%keyboard
active_cons=1:size(Ain,1); b=bin-Ain*x; active_cons=active_cons(b<1e-3); 
active_cons1=1:size(Ain,1); b=bin-Ain*x1; active_cons1=active_cons1(b<1e-3); 
