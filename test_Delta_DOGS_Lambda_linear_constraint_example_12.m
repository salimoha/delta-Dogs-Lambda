...
for kk=1:16
    for k=1:iter_max
        ...
        if mindis(x,xE) < minCoveringRadius
            %  keyboard
            break
        end
    ...
    switch EXAMPLE
        ...
        case('activ')
            if Dual==1
                ...
                figure_to_publish(strcat('./results_Lambda/example_3_activ_bs07903/ex3_activ_Lambda_',char(lattice),'_n_', num2str(n,'%02d')))
            end
    end
    ...
    switch EXAMPLE
        ...
        case('activ')
            if Dual==1
                ...
                save(strcat('./results_Lambda/example_3_activ_bs07903/ex3_activ_Lambda_',char(lattice),'_n_', num2str(n,'%02d')))
            end
    end
